...
argglobal
%argdel
$argadd inline-styles.html
edit 2-way-data-binding.html
...
wincmd w
argglobal
balt /media/admin/New\ Volume/prog_stuff_vue
let s:cpo_save=&cpo
set cpo&vim
...
balt ~/.vim/bundle/vim-snippets/UltiSnips/snippets.snippets
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("/media/admin/New\ Volume/prog_stuff_vue/inline-styles.html") | buffer /media/admin/New\ Volume/prog_stuff_vue/inline-styles.html | else | edit /media/admin/New\ Volume/prog_stuff_vue/inline-styles.html | endif
balt ~/.vim/bundle/vim-snippets/UltiSnips/html.snippets
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <C-N> <Plug>SparkupNext
imap <buffer> <C-E> <Plug>SparkupExecute
